...
#pragma region Base Scene
	...
	bool Scene::DoesHit(const Ray& ray) const
	{
		...
		for (size_t idx{}; idx < m_SphereGeometries.size(); idx++)
		{
			GeometryUtils::HitTest_Sphere(m_SphereGeometries[idx], adjustedRay, tempHitRecord);
		...
		for (size_t idx{}; idx < m_PlaneGeometries.size(); idx++)
		{
			GeometryUtils::HitTest_Plane(m_PlaneGeometries[idx], adjustedRay, tempHitRecord);
			if (tempHitRecord.didHit)
			{
				return true;
			}
